...
class MessengerController extends Controller
{
    ...
    public function destroy(MessengerTopic $topic)
    {
        ...
        // dd(s $topic);
        // $topic = MessengerTopic::findOrFail($topic->id);
        $topic->delete();
    ...
    // {
    //     $topics = Auth::user()->topics()->onlyTrashed()->with('receiver', 'sender')->orderBy('sent_at', 'desc')->get();
    //     $title  = 'Delete';
    //     return view('admin.messenger.delete', compact('topics', 'title'));
    // }
    // public function delete(MessengerTopic $id)
    // {
    //     dd($id);
    //     $user = Auth::user();
    //     if ($topic->receiver->id != $user->id && $topic->sender->id != $user->id) {
