...
// infformation routes
Route::get('/homeinfor', 'InformationController@index')->name('index');
Route::get('/listHome', 'InformationController@listHome')->name('listHome');
...
Route::group(['middleware' => ['auth', 'check_invitation'], 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    // Route::get('messenger/delete2', 'Admin\MessengerController@delete2')->name('messenger.delete2');
    // Route::get('messenger/delete/{id}', 'Admin\MessengerController@delete')->name('messenger.delete');
    Route::resource('messenger', 'Admin\MessengerController');
    Route::resource('tenants', 'Admin\TenantsController');
    Route::get('/tenants/update2/{id}', 'Admin\TenantsController@update2')->name('tenants.update2');
});
